...
const courses = [
  { title: "BPM", image: "/bannerServicios2.jpg" },
  { title: "Resolución Sanitaria", image: "/cursoextra5.jpg" },
  { title: "Etiquetado Nutricional", image: "/cursoextra2.webp" }
];
  ...
  return (
    ...
    >
      ...
      <Typography variant="h6" sx={{
        color: '#18148C', fontWeight: 600,
        fontSize: { xs: '0.9rem', sm: '1rem', md: '1.1rem' },
        textAlign: 'center', mt: 1, px: 1,
      }}>
        {title}
      </Typography>
    </Box>
...
const CursosCapacitacionesPageSection = () => {
  ...
  const handleOpen = (course) => { setSelectedCourse(course); setOpen(true); };
  const handleClose = () => { setOpen(false); setSelectedCourse(null); };
  const handleContact = () => { window.location.href = '/contacto'; };
  ...
  return (
    <Box sx={{
      ...
      <Typography variant="h4" sx={{
        ...
        fontSize: { xs: '1.4rem', sm: '1.8rem', md: '2.125rem', xl: '3rem' },
      ...
      <Dialog open={open} onClose={handleClose} maxWidth="xs" fullWidth>
        <DialogTitle sx={{
          color: '#18148C', fontWeight: 700,
          fontSize: { xs: '1.1rem', sm: '1.4rem' }, textAlign: 'center'
        }}>
        ...
        <DialogActions sx={{
          ...
          <Button
            ...
            sx={{
              bgcolor: '#18148C', color: '#fff', borderRadius: '24px',
              fontWeight: 600, px: 4, py: 1.2,
              fontSize: { xs: 14, sm: 16 }, textTransform: 'none',
              width: { xs: '100%', sm: 'auto' },
              '&:hover': { bgcolor: '#F2AC57', color: '#18148C' }
            }}
          >
            Contáctanos
          </Button>
          <Button
            onClick={handleClose}
            sx={{
              color: '#18148C', fontWeight: 500,
              ml: { xs: 0, sm: 2 }, mt: { xs: 0.5, sm: 0 },
              width: { xs: '100%', sm: 'auto' }
            }}
          >
            Cancelar
